...
```
📡 TikTok トレンドレーダー   JP   2026-08-26 22:05

商品 (TikTok Shop)
  #   点   状態       名前 / 根拠                          現在     伸び   報酬   競合
  1   90   📈上昇中   毛玉取り器 充電式                   1.7万   +185%   25%     28
                      販売が急増: 日次 +62% / 報酬率が高い (25%) / 紹介動画がまだ 28 本
  2   88   📈上昇中   温感アイマスク 20枚入               5.0万   +195%   20%     53
  3   67   ➖横ばい   スマホ冷却クーラー                  1,515    +26%   22%     19
```
...
- ✅ 66 件の自動テスト (時系列判定・正規化・DB・スコアリング・統合)
